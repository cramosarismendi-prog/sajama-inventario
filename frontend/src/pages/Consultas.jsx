...
import { Search, Package, AlertTriangle, Scan, ClipboardList, PackageMinus, PackagePlus, Printer, RefreshCw } from 'lucide-react'
                ...
                salidasFiltradas.length === 0 ? (
                  ...
                  <div className="overflow-x-auto">
                    <table className="table-auto w-full">
                      <thead><tr>
                        {['N°','Fecha','Solicitante','Unidad','Ítems','Total Bs','Por','Reimprimir'].map(h => (
              ...
              {tab === 'entradas' && (
                entradasFiltradas.length === 0 ? (
                  ...
                  <div className="overflow-x-auto">
                    <table className="table-auto w-full">
                      <thead><tr>
                        {['N°','Fecha','Proveedor','Fuente','Recibido por','Ítems','Total Bs','Por','Reimprimir'].map(h => (
                          <th key={h} className="th">{h}</th>
                        ))}
                      </tr></thead>
                      <tbody>
